...
function saveTestRun({ url, method, concurrency, totalRequests, totalDurationMs, metrics, results, scalingGroupId = null }) {
  ...
  const info = insertRun.run(
    url, method, concurrency, totalRequests, totalDurationMs,
    metrics.avgMs, metrics.minMs, metrics.maxMs,
    metrics.p50, metrics.p95, metrics.p99,
    metrics.successRate, metrics.throughputRps,
    scalingGroupId
  );
